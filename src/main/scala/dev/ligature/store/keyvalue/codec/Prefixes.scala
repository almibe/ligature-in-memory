...
private object Prefixes {
  val CollectionNameCounter: Byte = 0.toByte
  val CollectionNameToId: Byte = 1.toByte
  val IdToCollectionName: Byte = 2.toByte
  ...
  val NamedNodeToId: Byte = 11.toByte
  val IdToNamedNode: Byte = 12.toByte
  val AnonymousNodes: Byte = 13.toByte
